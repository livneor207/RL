# -*- coding: utf-8 -*-
"""Copy of RL_Mid-2022.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1veESLIS4HIvKLr1uaESWQIPBkzBcoTB0
...
class MazeView2D:
    ...
    def quit_game(self):
        try:
            ...
            pass
    def set_robot(self, desire_state):
            # move the robot to desire state
...
def run_episode():
  ...
  while not done:
    print(episode_history.__len__())
    print(env.state)
    action = env.action_space.sample()
    next_state, reward, done, info = env.step(action)
    episode_history.append((next_state, reward, action))
    print(episode_history)
  return episode_history

for i_epoisode_index in range(amount_of_episodes):
  episode_history  = run_episode()
...
print(next_state)
env.maze_view.set_robot( np.array([28,29]))
